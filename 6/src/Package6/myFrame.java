...
public class myFrame extends JFrame
{
	...
	myFrame() 
	{
		...
		final JTextField jtf11 = new JTextField(10);
		JLabel jl12 = new JLabel("Enter RepName");
		final JTextField jtf12 = new JTextField(10);
		JLabel jl13 = new JLabel("Enter State");
		final JTextField jtf13 = new JTextField(10);
		JLabel jl14 = new JLabel("Enter Commission");
		final JTextField jtf14 = new JTextField(10);
		JLabel jl15 = new JLabel("Enter Rate");
		final JTextField jtf15 = new JTextField(10);
		JButton jb1 = new JButton("Submit");

		
		JLabel jl21 = new JLabel("Enter CustomerNo");
		final JTextField jtf21 = new JTextField(10);
		JLabel jl22 = new JLabel("Enter CustomerName");
		final JTextField jtf22 = new JTextField(10);
		JLabel jl23 = new JLabel("Enter State");
		final JTextField jtf23 = new JTextField(10);
		JLabel jl24 = new JLabel("Enter Credit limit");
		final JTextField jtf24 = new JTextField(10);
		JLabel jl25 = new JLabel("Enter RepNo");
		final JTextField jtf25 = new JTextField(10);
